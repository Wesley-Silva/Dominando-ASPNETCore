namespace ASPNETCoreMVC.Models
{
    public class SocialIcon
    {
        ...
        public static List<SocialIcon> AppSocialIcons()
        {
            ...
            icons.Add(new SocialIcon { ID = 3, IconName = "YouTube", IconBgColor = "#007bb5", IconTargetUrl = "www.youtube.com", IconClass = "fa fa-youtube" });
            icons.Add(new SocialIcon { ID = 3, IconName = "Twitter", IconBgColor = "#55acee", IconTargetUrl = "www.twitter.com", IconClass = "fa fa-twitter" });
